# -*- coding: utf-8 -*-
# 国家中小学智慧教育平台 资源下载工具 v1.0
# 
# 参考这个https://github.com/happycola233/tchMaterial-parser/blob/main/src/tchMaterial-parser.pyw
...
root.title("国家中小学智慧教育平台 资源下载工具 v1.0") # 设置窗口标题
